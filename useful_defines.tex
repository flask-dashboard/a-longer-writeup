...
\newcommand{\install}{{\small \texttt{pip install Flask\_MonitoringDashboard}}\xspace}
...
\definecolor{myblue}{RGB}{57, 90, 121}
...
\newcommand{\epLearnedLanguage}{\epDecoration{api.learned\_language}}
