...
\subsection*{This is a LONGITUDINAL STUDY}

The dashboard has been deployed with the case stuy API for 
ten months, time in which more than 112.000 hits of the API have 
been recorded.

\subsection*{Role of Authors in the Case Study}
One of the authors leads the developer team that developers the API. 
