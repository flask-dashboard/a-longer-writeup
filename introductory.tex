...
\begin{itemize}
  ...
  \item A better categorization of the dashboard perspectives presented in Sections \ref{sec:util}, \ref{sec:grouping}, \ref{sec:evolution} including several new perspectives
  ...
  \item A discussion on the overhead incurred by the presented tool \ml{(... if we make it... )}
\end{itemize}
